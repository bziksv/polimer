...
class ProfileBanner
{
	...
	public static function shouldShow(): bool
	{
		...
		// «Отложить» работает везде, в том числе в ЛК и на info/security.
	...
	/** Страницы, где пользователь уже редактирует профиль — баннер не нужен. */
