...
$arComponentParameters = array(
    ...
    "PARAMETERS" => [
        'PRODUCT_ID'             => [
            "PARENT"   => "BASE",
            "NAME"     => Loc::getMessage("YASTORE.BADGE_COMPONENT_TCB_BUTTON_PARAM_PRODUCT_ID"),
            "TYPE"     => "STRING",
            "MULTIPLE" => "N",
            "DEFAULT"  => '={$arResult["ID"]}',
        ],
        ...
        'OFFERS'                 => [
            "PARENT"   => "BASE",
            "NAME"     => Loc::getMessage("YASTORE.BADGE_COMPONENT_TCB_BUTTON_PARAM_OFFERS"),
            "TYPE"     => "STRING",
            "MULTIPLE" => "N",
        ...
        'PERSON_TYPE_ID' => [
            "PARENT"   => "BASE",
            "NAME"     => Loc::getMessage("YASTORE.BADGE_COMPONENT_TCB_BUTTON_PARAM_PERSON_TYPE_ID"),
            "TYPE"     => "LIST",
            "MULTIPLE" => "N",
            "VALUES"   => $personTypes,
        ],
