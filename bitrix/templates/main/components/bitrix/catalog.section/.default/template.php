...
?>
        ...
        <div class="product_top">
            <? if(is_array($arResult['ITEM_SECTION_TOP']) && count($arResult['ITEM_SECTION_TOP']) > 0): ?>
            <div class="catalog_top cl">
                <? foreach($arResult['ITEM_SECTION_TOP'] as $arItem):?>
                <div class="item_c">
                    <a href="<?=$arItem['CODE']?>#products-list">
                        <div class="img_c">
            ...
            <? if(is_array($arResult['ITEM_FILTER_CATALOG']) && count($arResult['ITEM_FILTER_CATALOG']) > 0): ?>
                ...
                <div class="body_f">
                    ...
                    <div class="item_f">
                        ...
                        <? foreach ($arItem['PROP']['PARAM']['VALUE'] as $desc => $val):?>
                            <a href="<?=$arItem['PROP']['PARAM']['DESCRIPTION'][$desc]?>#products-list"><?=$val?></a>
                        <? endforeach; ?>
                    </div>
                    <? endforeach; ?>
                </div>
