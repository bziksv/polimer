   ...
   */
    ...
    if ($('#imageGallery').length) {
        ...
        var prepareProductGalleryLayout = function () {
            if (isMobileProductGallery()) {
                ...
                $productGallery.css({ width: '100%', maxWidth: '100%' });
            } else {
                $productGalleryWrap.css({ width: '', maxWidth: '', marginLeft: '', marginRight: '', float: '' });
                $productGallery.css({ width: '', maxWidth: '' });
            }
            if ($productGallery[0]) {
    ...
    */
    ...
    b.on('click', function(e) {
        e.preventDefault()
        if (window.matchMedia('(max-width: 1019px)').matches && typeof polimerToggleMobileFilter === 'function') {
    ...
    a.on('click', function() {
        if (window.matchMedia('(max-width: 1019px)').matches && typeof polimerCloseMobileFilter === 'function') {
