   ...
   */
    ...
    */
    ...
    b.on('click', function(e) {
        e.preventDefault()
        if (window.matchMedia('(max-width: 659px)').matches && typeof polimerToggleMobileFilter === 'function') {
    ...
    a.on('click', function() {
        if (window.matchMedia('(max-width: 659px)').matches && typeof polimerCloseMobileFilter === 'function') {
