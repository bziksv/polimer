...
$MESS["BX_CATALOG_EXPORT_EXTPRICE_OLD_PRICE_WARNING"] =
    '<div>Использование цены до скидки в вкладке ценообразования доступно только, если во вкладке <b>Параметры</b> -> <b>Детальные настройки</b> -> <b>Валюты и цены</b> -> для опции <b>Использовать (выводить) старую цену</b> выбрано значение <b>по умолчанию</b>.</div>'
    .'<div>В противном случае цена до скидки будет браться из опции <b>Использовать (выводить) старую цену</b>.</div>'
;
