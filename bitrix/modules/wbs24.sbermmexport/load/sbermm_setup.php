...
<tr class="wbs24_old_price_warning" style="display:none;">
    <td colspan="2">
        <div class="adm-info-message">
            <span><?=GetMessage("BX_CATALOG_EXPORT_EXTPRICE_OLD_PRICE_WARNING");?></span>
        </div>
    </td>
</tr>
<script>
{
    ...
    Adminhandlers.init(
        <?=CUtil::PhpToJSObject(unserialize(base64_decode($XML_DATA)));?>
    );
}
</script>
<?
