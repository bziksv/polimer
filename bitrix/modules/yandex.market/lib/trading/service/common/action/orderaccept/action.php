...
class Action extends TradingService\Common\Action\Cart\Action
{
	...
	public function process()
	{
		...
		try
		{
			...
			if ($checkResult->isSuccess())
			{
                ...
                $this->sendUpdateToMarket($orderNum);
    ...
    protected function sendUpdateToMarket($externalId)
    {
        ...
        $orderFacade::updateOrderNumber($this->provider->getOptions(), $order->getId(), $externalId);
    }
}