 ...
 * Class FunctionGte
 *
 * Шаблонная функция сравнения «больше или равно».
 *
 * Использование:
 *   {=gte A B} → вернёт true, если A >= B, иначе false.
 *
 * Правила сравнения:
 ...
 */
class FunctionGte extends Iblock\Template\Functions\FunctionBase implements HasConfiguration
{
    ...
    {
        return static::getLang('TEMPLATE_FUNCTION_GTE', null, 'gte');
    }
