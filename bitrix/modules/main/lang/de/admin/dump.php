...
$MESS["DUMP_BITRIXCLOUD_IS_IN_PROGRESS_CHANGE_ERROR"] = "Back-up-Parameter können nicht geändert werden, weil der Cloud-Service momentan ein Back-up erstellt. Bitte warten Sie, bis das Back-up abgeschlossen wird.";
$MESS["DUMP_BITRIXCLOUD_IS_IN_PROGRESS_CHANGE_WARNING"] = "Back-up-Parameter können nicht geändert werden, weil der Cloud-Service momentan ein Back-up erstellt.";
...
$MESS["DUMP_MAIN_BXCLOUD_INFO"] = "&quot;Bitrix24&quot; bietet einen kostenlosen Speicherplatz im Bitrix Cloud-Speicher zur Aufbewahrung von drei Sicherungskopien für jeweils eine aktive Lizenz an. Der Zugriff auf die Sicherungskopien wird nach Lizenzschlüssel und Passwort gewährt. Ohne Passwort kann niemand (auch Bitrix Mitarbeiter nicht) auf Ihre Daten zugreifen.";
...
$MESS["MAIN_DUMP_NOT_INSTALLED1"] = "Das PHP-Modul Openssl ist nicht installiert.";
