...
/*ZDUyZmZNDJjMTc5YjJiMTExNTMzYjNhMmE0ZjFkMjI3OTgyZDU=*/$GLOBALS['____1689199196']= array(base64_decode('ZGVm'.'aW5l'));if(!function_exists(__NAMESPACE__.'\\___1731285925')){function ___1731285925($_274158349){static $_1300876345= false; if($_1300876345 == false) $_1300876345=array('RU'.'5D'.'T0RF','W'.'Q==');return base64_decode($_1300876345[$_274158349]);}};class CBXFeatures{ public static function IsFeatureEnabled($_487185069){ return true;} public static function IsFeatureEditable($_487185069){ return true;} public static function SetFeatureEnabled($_487185069, $_1543310366= true){} public static function SaveFeaturesSettings($_1944724866, $_256748776){} public static function GetFeaturesList(){ return array();} public static function InitiateEditionsSettings($_1439189945){} public static function ModifyFeaturesSettings($_1439189945, $_399806305){} public static function IsFeatureInstalled($_487185069){ return true;}} $GLOBALS['____1689199196'][0](___1731285925(0), ___1731285925(1));/**/			//Do not remove this
