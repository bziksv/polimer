...
<div class="cat insan">
	...
	<ul class="cat-ul">
		...
		<li class="cat-li">
			<a href="<?=$sec_2['SECTION_PAGE_URL']?>" class="title <?if($arParams["VARIABLES"] == $sec_2['CODE']):?>underline<?endif;?>" <? if(is_array($sec_2['SECTION_2']) && count($sec_2['SECTION_2']) != 0): ?> onclick="return false" <? endif; ?>>
				<? if(is_array($sec_2['SECTION_2']) && count($sec_2['SECTION_2']) != 0): ?> <div class="cube"><span></span><span></span></div> <? endif; ?>
				<?=$sec_2['NAME']?>
			</a>
			<div class="inner">
