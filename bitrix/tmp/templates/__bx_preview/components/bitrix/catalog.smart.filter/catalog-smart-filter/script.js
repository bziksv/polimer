function JCSmartFilter(ajaxURL, viewMode, params)
{
	...
	this.$filter = $(".bx-filter");
	this.$unexpanded = this.$filter.find("li.unexpanded");
	this.$unexpanded.css("margin-left", "15px");
...
JCSmartFilter.prototype.showAll = function(dom)
{
	let $el = $(dom);
	
	this.$unexpanded.toggleClass(function() {
	  if ( $( this ).is( ".unexpanded" ) ) {
		$el.text("Свернуть");
	  } else {
		$el.text("Показать все фильтры");
	  }
