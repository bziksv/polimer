		...
		<form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smartfilter">
			...
			<div class="row">
				...
				foreach($arResult["ITEMS"] as $key=>$arItem)
				{
					...
					<li class="cat-li <?=((isset($arItem['CODE']) && is_array($config['section_filter'][$arResult['SECTION']['ID']]) && in_array($arItem['CODE'], $config['section_filter'][$arResult['SECTION']['ID']])) || $arItem["DISPLAY_EXPANDED"] == "Y") ? "li-open" : null?><?=($arItem['EXPANDED']) ? "expanded" : "unexpanded"?>">
						<span class="bx-filter-container-modef"></span>
				...
				<? if($arResult['DISPLAY_EXPANDED']): ?>
				<li class="cat-li">	
					<a href="javascript:void(0)" class="title" onclick="smartFilter.showAll(this)" style="color: #0464bb">Показать все фильтры</a>
				</li>
				<? endif; ?>
